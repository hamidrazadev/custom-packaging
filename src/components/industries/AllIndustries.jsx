            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 3xl:grid-cols-6 w-full gap-4 px-2 py-4">
                {
                    allIndustries.map((industry, index) => {
                        return (
                            <Link key={index} href={`/industries/${industry.href}`} className='bg-primary-foreground w-full h-full rounded-md shadow hover:shadow-sm hover:scale-[1.025] p-4 flex flex-col items-center justify-center transition-all'>
